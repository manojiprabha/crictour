    ...
    function Item({ icon, label, path }: { icon: string, label: string, path: string }) {
        ...
        return (
            ...
            <Button
                ...
                className={`flex flex-col items-center justify-center p-0 h-auto gap-1 text-xs hover:bg-transparent ${active ? "text-emerald-600" : "text-slate-500 hover:text-emerald-600"
                    }`}
            >
